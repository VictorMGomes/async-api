...
The package discovers all `#[AsyncApi]`-attributed events that implement
`ShouldBroadcast`, extracts their schemas, and registers a route that serves
the AsyncAPI 3.0 JSON specification. Visit `/docs/ws` in your application to
